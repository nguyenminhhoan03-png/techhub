...
Kiểm tra tính khả dụng của Proxy HTTP/HTTPS/SOCKS4/SOCKS5 trong thời gian thực. Đo độ trễ ping ms, kiểm tra IP thoát và mức độ ẩn danh bảo mật.',
    ...
    'sql-formatter' => [
        'name' => 'Định Dạng & Làm Đẹp Câu Lệnh SQL',
        'summary' => 'Định dạng, thụt dòng và viết hoa từ khóa SQL chuẩn mực (SELECT, INSERT, UPDATE, DELETE), hỗ trợ chế độ làm đẹp hoặc nén gọn 1 dòng.',
        'meta_title' => 'SQL Formatter & Beautifier Online — Làm Đẹp Mã SQL Chuẩn | TechHub',
        'meta_description' => 'Định dạng câu lệnh SQL trực tuyến, thụt lề 2/4 spaces, viết hoa từ khóa SQL, hỗ trợ beautify và minify cực nhanh.',
    ],
    'sql-to-laravel-migration' => [
        'name' => 'Chuyển Đổi SQL sang Laravel Migration',
        'summary' => 'Chuyển đổi câu lệnh SQL CREATE TABLE thành mã nguồn Laravel Migration Schema::create hoàn chỉnh, tự động suy luận kiểu cột và khóa ngoại.',
        'meta_title' => 'SQL to Laravel Migration Converter — Chuẩn Laravel 11/12 | TechHub',
        'meta_description' => 'Chuyển đổi câu lệnh SQL CREATE TABLE sang Laravel Migration Schema::create tự động với đầy đủ indexes, foreign keys, timestamps.',
    ],
    'sql-to-laravel-model' => [
        'name' => 'Chuyển Đổi SQL sang Laravel Eloquent Model',
        'summary' => 'Chuyển đổi bảng SQL thành Eloquent Model PHP hoàn chỉnh với $table, $fillable, casts() và quan hệ belongsTo tự động.',
        'meta_title' => 'SQL to Laravel Eloquent Model Generator — Chuẩn Laravel 11/12 | TechHub',
        'meta_description' => 'Tự động tạo Model Eloquent PHP từ bảng SQL: khai báo fillable, casts(), relationships chuẩn mực Laravel 11 và 12.',
    ],
    'laravel-crud-generator' => [
        'name' => 'Laravel CRUD Generator (Full Scaffolding)',
        'summary' => 'Sinh trọn bộ mã nguồn CRUD cho Laravel: Model, Migration, Form Request, API Controller, API Resource và Route.',
        'meta_title' => 'Laravel CRUD Generator Online — Trọn Bộ Controller, Model, Request | TechHub',
        'meta_description' => 'Tự động sinh trọn bộ scaffolding Laravel CRUD: Migration, Model, Form Requests, ApiController và Resource chuẩn Clean Architecture.',
    ],
    'uuid-generator' => [
        'name' => 'Tạo UUID & ULID Trực Tuyến Hàng Loạt',
        'summary' => 'Sinh mã định danh duy nhất UUID v4, UUID v7 (sắp xếp theo thời gian), UUID v1 và ULID với số lượng tùy chọn, hỗ trợ chữ hoa/thường.',
        'meta_title' => 'UUID & ULID Generator Online — Tạo Mã UUID v4, v7, v1 Hàng Loạt | TechHub',
        'meta_description' => 'Tạo mã UUID v4, UUID v7 time-ordered, ULID bảo mật cao hàng loạt, hỗ trợ định dạng chữ hoa và có hoặc không dấu gạch nối.',
    ],
    'cron-generator' => [
        'name' => 'Tạo & Giải Thích Biểu Thức Cron',
        'summary' => 'Tạo biểu thức Cron 5 trường (* * * * *), giải thích bằng ngôn ngữ tự nhiên tiếng Việt và tính toán 5 mốc chạy tiếp theo.',
        'meta_title' => 'Cron Expression Generator & Explainer — Tính Lịch Chạy Chi Tiết | TechHub',
        'meta_description' => 'Tạo và giải thích biểu thức Cron (* * * * *) sang tiếng Việt, tính 5 thời điểm chạy tiếp theo và sinh code Laravel Scheduler.',
    ],
    'html-formatter' => [
        'name' => 'Định Dạng & Nén Gọn Mã HTML',
        'summary' => 'Làm đẹp (Beautify) hoặc nén gọn (Minify) mã nguồn HTML, thụt lề chuẩn phân cấp DOM và tối ưu hóa dung lượng.',
        'meta_title' => 'HTML Formatter & Minifier Online — Làm Đẹp & Nén HTML | TechHub',
        'meta_description' => 'Định dạng và nén gọn mã HTML trực tuyến, thụt lề chuẩn DOM, loại bỏ khoảng trắng thừa, tính toán phần trăm tiết kiệm dung lượng.',
    ],
    'css-minifier' => [
        'name' => 'Nén Gọn & Tối Ưu Hóa Stylesheet CSS',
        'summary' => 'Nén gọn CSS, loại bỏ ghi chú và khoảng trắng thừa, tính toán phần trăm dung lượng tiết kiệm hoặc làm đẹp thụt lề chuẩn.',
        'meta_title' => 'CSS Minifier & Beautifier Online — Nén Gọn & Tối Ưu CSS | TechHub',
        'meta_description' => 'Nén gọn file CSS, tối ưu hóa dung lượng website, rút gọn mã màu HEX, hỗ trợ cả hai chế độ Minify và Beautify.',
    ],
    'image-compressor' => [
        'name' => 'Nén Ảnh Trực Tuyến (WebP, JPEG, PNG)',
        'summary' => 'Nén và giảm dung lượng hình ảnh trực tuyến với thuật toán GD tối ưu, tùy chỉnh chất lượng và kích thước, xem trước kết quả.',
        'meta_title' => 'Nén Ảnh Trực Tuyến Online — Giảm Dung Lượng WebP, JPEG, PNG | TechHub',
        'meta_description' => 'Nén ảnh trực tuyến tốc độ cao, chuyển đổi định dạng sang WebP giúp giảm 80% dung lượng mà vẫn giữ nguyên chất lượng hiển thị.',
    ],
    'pdf-to-excel' => [
        'name' => 'Chuyển Đổi Bảng PDF sang Excel & CSV',
        'summary' => 'Bóc tách bảng biểu và cấu trúc dữ liệu dòng cột từ tài liệu PDF sang tệp CSV và bảng tính tương thích Microsoft Excel.',
        'meta_title' => 'PDF to Excel / CSV Converter Online — Bóc Tách Bảng Dữ Liệu | TechHub',
        'meta_description' => 'Chuyển đổi dữ liệu bảng biểu từ tài liệu PDF sang bảng tính Excel và CSV tương thích, xem trước trực tiếp trên trình duyệt.',
    ],
    'csv-to-json' => [
        'name' => 'Chuyển Đổi CSV sang JSON',
        'summary' => 'Chuyển đổi dữ liệu bảng tính CSV sang định dạng JSON Array/Object, tự động nhận diện kiểu số, boolean và hỗ trợ nhiều dấu phân cách.',
        'meta_title' => 'CSV to JSON Converter Online — Tự Động Ép Kiểu Dữ Liệu | TechHub',
        'meta_description' => 'Chuyển đổi file CSV sang JSON nhanh chóng, hỗ trợ nhận diện kiểu dữ liệu số, boolean, tùy chọn phân cách phẩy, chấm phẩy, tab.',
    ],
    'xml-to-json' => [
        'name' => 'Chuyển Đổi XML sang JSON',
        'summary' => 'Chuyển đổi cấu trúc tài liệu XML hoặc RSS Feed sang định dạng JSON tiêu chuẩn, hỗ trợ bóc tách thuộc tính và thẻ lồng nhau.',
        'meta_title' => 'XML to JSON Converter Online — Chuyển Đổi XML & RSS Feed | TechHub',
        'meta_description' => 'Chuyển đổi tài liệu XML sang JSON dễ dàng, kiểm tra lỗi cú pháp XML chặt chẽ và tạo chuỗi JSON phân cấp rõ ràng.',
    ],
    'api-tester' => [
        'name' => 'API Tester & REST Client Trực Tuyến',
        'summary' => 'Gửi yêu cầu HTTP (GET, POST, PUT, DELETE) kiểm tra API với headers và body tùy chỉnh, đo độ trễ và bảo vệ chống SSRF.',
        'meta_title' => 'API Tester Online — Kiểm Tra RESTful API Trực Tiếp | TechHub',
        'meta_description' => 'Công cụ kiểm tra API RESTful trực tuyến: gửi request GET, POST, PUT, DELETE, tùy biến headers, đo độ trễ ping và xem response formatted.',
    ],
    'http-status-checker' => [
        'name' => 'Kiểm Tra Trạng Thái HTTP & Chuỗi Chuyển Hướng',
        'summary' => 'Kiểm tra mã trạng thái phản hồi HTTP, truy vết toàn bộ chuỗi chuyển hướng 301/302, kiểm tra chứng chỉ SSL và thời gian phản hồi.',
        'meta_title' => 'HTTP Status & Redirect Tracer — Kiểm Tra Chuỗi Chuyển Hướng | TechHub',
        'meta_description' => 'Kiểm tra mã phản hồi HTTP 200, 301, 302, 404, 500 của URL, theo dõi chuỗi chuyển hướng hop-by-hop và kiểm tra tính hợp lệ của SSL.',
    ],
    'password-generator' => [
        'name' => 'Tạo Mật Khẩu Ngẫu Nhiên An Toàn & Đánh Giá Độ Mạnh',
        'summary' => 'Tạo mật khẩu ngẫu nhiên bảo mật cao với CSPRNG, tùy chỉnh độ dài và tập ký tự, phân tích độ mạnh Shannon Entropy.',
        'meta_title' => 'Password Generator & Analyzer — Tạo Mật Khẩu Mạnh Bảo Mật | TechHub',
        'meta_description' => 'Tạo mật khẩu ngẫu nhiên bảo mật cao bằng hàm random_int chuẩn mã hóa, đo độ mạnh Shannon Entropy và loại trừ ký tự gây nhầm lẫn.',
    ],
    'timestamp-converter' => [
        'name' => 'Chuyển Đổi Unix Timestamp & Ngày Giờ',
        'summary' => 'Chuyển đổi 2 chiều giữa Unix Epoch Timestamp (giây/mili-giây) và ngày giờ người đọc (UTC, GMT+7, ISO 8601), tính khoảng cách thời gian tương đối.',
        'meta_title' => 'Unix Timestamp Converter Online — Chuyển Đổi Epoch Sang Ngày Giờ | TechHub',
        'meta_description' => 'Chuyển đổi Unix Timestamp sang ngày giờ theo múi giờ địa phương và UTC, tính thời gian tương đối, chuyển đổi ngược ngày giờ sang Epoch.',
    ],
];
