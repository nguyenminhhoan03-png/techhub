...
4. **Step 4**: Inspect the live status table and copy all verified active proxies.',
    ...
    'json-to-typescript' => [
        'name' => 'JSON to TypeScript Converter (Interface / Type)',
        'summary' => 'Convert raw JSON data into type-safe TypeScript interfaces or type aliases with automatic nested object extraction.',
        'meta_title' => 'JSON to TypeScript Converter Online — Generate Clean Interfaces | TechHub',
        'meta_description' => 'Instantly convert JSON objects to TypeScript interfaces and types with nested structures, optional fields, and clean formatting.',
    ],
    'json-to-php' => [
        'name' => 'JSON to PHP Array & DTO Class',
        'summary' => 'Convert raw JSON into modern short array syntax [...] or PHP 8.2+ Data Transfer Object (DTO) classes with constructor property promotion.',
        'meta_title' => 'JSON to PHP Array & DTO Generator — Modern PHP 8.2+ | TechHub',
        'meta_description' => 'Convert JSON strings to PHP arrays or typed DTO classes with readonly properties, parameter types, and fromArray factory method.',
    ],
    'sql-formatter' => [
        'name' => 'SQL Formatter & Beautifier',
        'summary' => 'Format, indent, and uppercase keywords in complex SQL queries (SELECT, INSERT, UPDATE, DELETE), supporting beautify and minify modes.',
        'meta_title' => 'SQL Formatter & Beautifier Online — Clean SQL Syntax | TechHub',
        'meta_description' => 'Free online SQL formatter: beautify queries, uppercase keywords, customize 2/4 spaces indentation, or minify SQL to a single line.',
    ],
    'sql-to-laravel-migration' => [
        'name' => 'SQL to Laravel Migration Converter',
        'summary' => 'Convert SQL CREATE TABLE statements into complete Laravel Migration Schema::create files with types, indexes, and foreign keys.',
        'meta_title' => 'SQL to Laravel Migration Converter — Laravel 11/12 Compatible | TechHub',
        'meta_description' => 'Automatically parse SQL CREATE TABLE schema into clean Laravel Schema::create migration code with foreignId, indexes, timestamps.',
    ],
    'sql-to-laravel-model' => [
        'name' => 'SQL to Laravel Eloquent Model Generator',
        'summary' => 'Convert SQL tables into complete PHP Eloquent Models with $table, $fillable, casts() methods, and belongsTo relationships.',
        'meta_title' => 'SQL to Laravel Eloquent Model Generator — Laravel 11/12 | TechHub',
        'meta_description' => 'Generate production-ready Laravel 11/12 Eloquent Models from SQL tables with fillable columns, type casts, and relationship methods.',
    ],
    'laravel-crud-generator' => [
        'name' => 'Laravel CRUD Generator (Full Scaffolding)',
        'summary' => 'Generate complete Laravel CRUD scaffolding: Model, Migration, Store/Update Form Requests, ApiController, Resource, and Routes.',
        'meta_title' => 'Laravel CRUD Generator Online — Full Scaffolding Suite | TechHub',
        'meta_description' => 'Generate full Laravel CRUD scaffolding from field definitions: Migration, Model, FormRequests, ApiController, and JsonResource.',
    ],
    'uuid-generator' => [
        'name' => 'Bulk UUID & ULID Generator',
        'summary' => 'Generate cryptographically random UUID v4, time-ordered UUID v7, UUID v1, and ULID in bulk with customizable casing and hyphens.',
        'meta_title' => 'UUID & ULID Generator Online — Bulk UUID v4, v7, v1, ULID | TechHub',
        'meta_description' => 'Generate secure UUIDs (v4, v7 time-ordered, v1) and ULIDs online in bulk (1-50) with options for uppercase and hyphen formatting.',
    ],
    'cron-generator' => [
        'name' => 'Cron Expression Generator & Explainer',
        'summary' => 'Build and explain standard 5-part cron expressions (* * * * *), calculate next 5 run schedules, and get Laravel scheduler snippets.',
        'meta_title' => 'Cron Expression Generator & Explainer — Schedule Calculator | TechHub',
        'meta_description' => 'Generate and explain cron expressions in plain language, preview the next 5 execution timestamps, and copy Laravel task scheduler code.',
    ],
    'html-formatter' => [
        'name' => 'HTML Formatter & Minifier',
        'summary' => 'Beautify or minify HTML source code with clean DOM indentation, whitespace optimization, and file size savings calculation.',
        'meta_title' => 'HTML Formatter & Minifier Online — Clean & Compress HTML | TechHub',
        'meta_description' => 'Beautify or minify HTML markup online: clean hierarchical indentation, whitespace trimming, and compression savings calculation.',
    ],
    'css-minifier' => [
        'name' => 'CSS Minifier & Beautifier',
        'summary' => 'Minify stylesheets by removing comments, redundant spaces, and color codes, or beautify CSS with standard 2/4 spaces indentation.',
        'meta_title' => 'CSS Minifier & Beautifier Online — Optimize Stylesheets | TechHub',
        'meta_description' => 'Fast online CSS minifier and beautifier: strip comments and whitespace, shrink HEX colors, and calculate saved byte percentages.',
    ],
    'image-compressor' => [
        'name' => 'Online Image Compressor (WebP, JPEG, PNG)',
        'summary' => 'Compress and optimize images online using advanced GD algorithms, customize quality and dimensions, with live preview.',
        'meta_title' => 'Online Image Compressor — Compress WebP, JPEG, PNG Free | TechHub',
        'meta_description' => 'Compress images online with adjustable quality (10-100%), convert to WebP to save up to 80% file size without visual quality loss.',
    ],
    'pdf-to-excel' => [
        'name' => 'PDF to Excel / CSV Converter',
        'summary' => 'Extract tabular data and column structures from PDF text into interactive spreadsheets, downloadable as Excel-compatible CSV.',
        'meta_title' => 'PDF to Excel / CSV Converter Online — Extract Tabular Data | TechHub',
        'meta_description' => 'Convert PDF table rows and structured columns into editable spreadsheet data and Excel-ready CSV files with in-browser preview.',
    ],
    'csv-to-json' => [
        'name' => 'CSV to JSON Converter',
        'summary' => 'Convert spreadsheet CSV data into formatted JSON arrays and objects with automatic type-casting for numbers, booleans, and nulls.',
        'meta_title' => 'CSV to JSON Converter Online — Auto Type-Casting & Delimiters | TechHub',
        'meta_description' => 'Easily convert CSV files to structured JSON arrays: auto-detect delimiters (comma, semicolon, tab), cast numbers, and format output.',
    ],
    'xml-to-json' => [
        'name' => 'XML to JSON Converter',
        'summary' => 'Convert XML documents and RSS feeds into formatted JSON objects with full attribute extraction and nested element handling.',
        'meta_title' => 'XML to JSON Converter Online — Convert XML & RSS Feeds | TechHub',
        'meta_description' => 'Convert XML markup to clean JSON with syntax validation, element attribute extraction, and indentation customization.',
    ],
    'api-tester' => [
        'name' => 'API Tester & REST Client',
        'summary' => 'Send HTTP requests (GET, POST, PUT, DELETE) to test RESTful APIs with custom headers, body payloads, latency timing, and SSRF security.',
        'meta_title' => 'Online API Tester & REST Client — Test Endpoints Safely | TechHub',
        'meta_description' => 'Test REST APIs online: send GET, POST, PUT, DELETE requests with headers and payload, measure latency ping, and view formatted responses.',
    ],
    'http-status-checker' => [
        'name' => 'HTTP Status & Redirect Tracer',
        'summary' => 'Inspect HTTP status codes, trace full 301/302 redirect chains hop-by-hop, verify SSL certificates, and measure server response latency.',
        'meta_title' => 'HTTP Status Checker & Redirect Tracer — Verify URL Hops | TechHub',
        'meta_description' => 'Inspect HTTP status codes (200, 301, 302, 404, 500), follow redirect chains, verify SSL validity, and measure server latency.',
    ],
    'password-generator' => [
        'name' => 'Password Generator & Analyzer',
        'summary' => 'Generate cryptographically secure random passwords using CSPRNG, customize length and character sets, and analyze Shannon Entropy.',
        'meta_title' => 'Password Generator & Analyzer — Strong Random Passwords | TechHub',
        'meta_description' => 'Generate strong passwords using CSPRNG, evaluate entropy bits, exclude ambiguous characters, and generate passwords in bulk.',
    ],
    'timestamp-converter' => [
        'name' => 'Unix Timestamp Converter',
        'summary' => 'Bidirectional conversion between Unix Epoch timestamps (seconds/ms) and human-readable dates (UTC, Local, ISO 8601) with relative time.',
        'meta_title' => 'Unix Timestamp Converter Online — Epoch to Human Date | TechHub',
        'meta_description' => 'Convert Unix timestamps to human-readable dates in local and UTC timezones, calculate relative elapsed time, and convert dates to Epoch.',
    ],
];
