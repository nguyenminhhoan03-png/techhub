...
final class GetToolsQueryHandler extends QueryHandler
{
     ...
     */
    public function handle(GetToolsQuery $query): Collection
    {
        $tools = $this->toolRepository->getTools($query->categorySlug, $query->search);

        return $tools->map(function ($tool): ToolData {
